!function e(t, r, n) {
        ...
        (function(t) {
            (function() {
                ...
                var r = d(e("loglevel"))
                  ...
                  , o = d(e("@metamask/object-multiplex"))
                  , a = e("readable-stream")
    ...
    3: [function(e, t, r) {
        "use strict";
        var n, s, i, o, a, c, u, l, f, d, h, p, g, m = this && this.__classPrivateFieldSet || function(e, t, r, n, s) {
            if ("m" === n)
    ...
    15: [function(e, t, r) {
        ...
        const i = e("./transports/externallyConnectableTransport.cjs")
          , o = e("./transports/windowPostMessageTransport.cjs")
    }
    , {
            ...
            return {
                connect: async () => {
                    try {
                        ...
                        let e = !0;
                        return t.onDisconnect.addListener(( () => {
                            e = !1,
                        ...
                        e ? (t.onMessage.addListener(c),
                        !0) : !1
                    } catch (e) {
                        return console.error("[ChromeTransport] connectChrome error:", e),
                        !1
                    }
                }
                ,
                    ...
                    !function(e) {
                        for (const t of s)
                            try {
                                ...
                                console.error("[WindowPostMessageTransport] Error in notification callback:", e)
                            }
                    }(e);
                else if (t.has(e.id)) {
    ...
    36: [function(e, t, r) {
        ...
        r.initializeProvider = function({connectionStream: e, logger: t=console, maxEventListeners: r=100, providerInfo: n, shouldSendMetadata: u=!0, shouldSetOnWindow: l=!0, shouldShimWeb3: f=!1, shouldAnnounceCaip294: d=!0}) {
    ...
    53: [function(e, t, r) {
        (function(t) {
            (function() {
                "use strict";
                var n, s, i, o, a, c, u, l, f, d, h, p, g, m, y, w, b, v, E, _, M, S = this && this.__classPrivateFieldGet || function(e, t, r, n) {
                    if ("a" === r && !n)
                        throw new TypeError("Private accessor was defined without a getter");
                    if ("function" == typeof t ? e !== t || !n : !t.has(e))
                        throw new TypeError("Cannot read private member from an object whose class did not declare it");
                ...
                , j = this && this.__classPrivateFieldSet || function(e, t, r, n, s) {
                    if ("m" === n)
                        throw new TypeError("Private method is not writable");
                    if ("a" === n && !s)
                        throw new TypeError("Private accessor was defined without a setter");
                ...
                const A = e("@solana/wallet-standard-chains")
                  , C = e("@solana/wallet-standard-features")
                  , R = e("@wallet-standard/features")
                  , N = e("@wallet-standard/wallet")
                  , O = I(e("bs58"))
                  , T = e("./icon.cjs")
                  , P = e("./types.cjs")
                  , x = e("./utils.cjs");
                class k extends N.ReadonlyWalletAccount {
                    constructor({address: e, publicKey: t, chains: r}) {
                        super({
                            address: e,
                            publicKey: t,
                            chains: r,
                            features: [C.SolanaSignAndSendTransaction, C.SolanaSignTransaction, C.SolanaSignMessage, C.SolanaSignIn]
                        }),
                        new.target === k && Object.freeze(this)
                    }
                }
                r.MetamaskWalletAccount = k;
                r.MetamaskWallet = class {
                    ...
                    get features() {
                        return {
                            ...
                            [R.StandardDisconnect]: {
                                version: this.version,
                                disconnect: S(this, p, "f")
                            },
                            [R.StandardEvents]: {
                                version: this.version,
                                on: S(this, u, "f")
                            },
                            [C.SolanaSignAndSendTransaction]: {
                                version: this.version,
                                supportedTransactionVersions: ["legacy", 0],
                                signAndSendTransaction: S(this, g, "f")
                            },
                            [C.SolanaSignTransaction]: {
                                version: this.version,
                                supportedTransactionVersions: ["legacy", 0],
                                signTransaction: S(this, m, "f")
                            },
                            [C.SolanaSignMessage]: {
                                version: this.version,
                                signMessage: S(this, y, "f")
                            }
                        }
                    }
                    constructor({client: e, walletName: r}) {
                        ...
                        s.set(this, {}),
                        this.version = "1.0.0",
                        this.icon = T.metamaskIcon,
                        this.chains = [A.SOLANA_MAINNET_CHAIN, A.SOLANA_DEVNET_CHAIN, A.SOLANA_TESTNET_CHAIN],
                        i.set(this, void 0),
                        o.set(this, void 0),
                        a.set(this, void 0),
                        c.set(this, void 0),
                        u.set(this, ( (e, t) => (S(this, s, "f")[e] ? S(this, s, "f")[e]?.push(t) : S(this, s, "f")[e] = [t],
                        () => S(this, n, "m", f).call(this, e, t)))),
                        d.set(this, (async () => this.accounts.length ? {
                            accounts: this.accounts
                        } : (await S(this, _, "f").call(this),
                        this.accounts.length || await S(this, M, "f").call(this, P.Scope.MAINNET),
                        this.accounts.length ? (j(this, c, this.client.onNotification(S(this, n, "m", w).bind(this)), "f"),
                        {
                            accounts: this.accounts
                        }) : {
                            accounts: []
                        ...
                        h.set(this, (async (...e) => {
                            if (!(S(this, a, "f") && S(this, i, "f") || (await S(this, d, "f").call(this),
                            S(this, a, "f") && S(this, i, "f"))))
                                ...
                                const e = await this.client.invokeMethod({
                                    ...
                                    request: {
                                        ...
                                        params: {
                                            ...
                                            address: n.address || S(this, a, "f").address
                                        }
                                    }
                                });
                                r.push({
                        ...
                        p.set(this, (async () => {
                            j(this, a, void 0, "f"),
                            j(this, i, void 0, "f"),
                            S(this, c, "f")?.call(this),
                            j(this, c, void 0, "f"),
                            S(this, n, "m", l).call(this, "change", {
                                accounts: this.accounts
                            }),
                        ...
                        g.set(this, (async (...e) => {
                            ...
                            if (!r)
                                throw new Error("Not connected");
                            S(this, E, "f").call(this, e);
                            const n = (0,
                            x.getScopeFromWalletStandardChain)(e[0]?.chain)
                              , s = await this.client.getSession()
                              , o = s?.sessionScopes[n]?.accounts;
                            o?.includes(`${n}:${r.address}`) ? j(this, i, n, "f") : await S(this, M, "f").call(this, n, [r.address]);
                            const c = [];
                            for (const {transaction: r, account: s} of e) {
                                ...
                                c.push({
                                    signature: O.default.decode(i.signature)
                                })
                            }
                            return c
                        }
                        ...
                        _.set(this, (async () => {
                            try {
                                ...
                                if (!e)
                                    return;
                                const t = await S(this, o, "f");
                                S(this, n, "m", b).call(this, e, t)
                            } catch (e) {
                                console.warn("Error restoring session", e)
                            }
                        }
                        )),
                        M.set(this, (async (e, t) => {
                            let r;
                            const s = new Promise((e => {
                              ...
                              , a = await Promise.race([s, new Promise((e => setTimeout(( () => e(void 0)), 200)))]);
                            S(this, n, "m", b).call(this, o, a)
                        }
                        )),
                        this.client = e,
                        this.name = `${r ?? "MetaMask"}\ufeff`,
                        j(this, o, this.getInitialSelectedAddress(), "f")
                    }
                }
                ,
                s = new WeakMap,
                ...
                n = new WeakSet,
                l = function(e, ...t) {
                    for (const r of S(this, s, "f")[e] ?? [])
                        r.apply(null, t)
                }
                ,
                f = function(e, t) {
                    S(this, s, "f")[e] = S(this, s, "f")[e]?.filter((e => t !== e))
                }
                ,
                w = async function(e) {
                    if (!(0,
                    ...
                    const t = await this.client.getSession()
                      , r = e?.params?.notification?.params?.[0];
                    if (!r)
                        return console.log("No address to select, disconnecting"),
                        await S(this, p, "f").call(this),
                        void console.log("this.accounts", this.accounts);
                    S(this, n, "m", b).call(this, t, r)
                }
                ,
                b = function(e, t) {
                    const r = new Set(Object.keys(e?.sessionScopes ?? {}))
                      , s = [P.Scope.MAINNET, P.Scope.DEVNET, P.Scope.TESTNET].find((e => r.has(e)));
                    if (!s)
                        return void j(this, a, void 0, "f");
                    const o = e?.sessionScopes[s]?.accounts;
                    if (!o?.[0])
                        throw S(this, p, "f").call(this),
                        new Error("No accounts in scope");
                    let c;
                    c = t && o.includes(`${s}:${t}`) ? t : S(this, a, "f")?.address && o.includes(`${s}:${S(this, a, "f")?.address}`) ? S(this, a, "f").address : (0,
                    x.getAddressFromCaipAccountId)(o[0]),
                    j(this, a, S(this, n, "m", v).call(this, c), "f"),
                    j(this, i, s, "f"),
                    S(this, n, "m", l).call(this, "change", {
                        accounts: this.accounts
                    })
    ...
    87: [function(e, t, r) {
        ...
        r.hexToBytes = function(e) {
            ...
            s += 2) {
                const r = d(e.charCodeAt(s))
                  , i = d(e.charCodeAt(s + 1));
    ...
    88: [function(e, t, r) {
        ...
        function y(e, t, r) {
            ...
            for (; ; ) {
                ...
                for (let s = n; s < o; s++) {
                    ...
                    if (i[s] = f,
                    !Number.isSafeInteger(f) || f * r + e !== u)
                        throw new Error("convertRadix: carry overflow");
                    a && (f ? a = !1 : n = s)
                }
                if (s.push(e),
        ...
        r.base16 = d(M(4), h("0123456789ABCDEF"), p("")),
        r.base32 = d(M(5), h("ABCDEFGHIJKLMNOPQRSTUVWXYZ234567"), g(5), p("")),
        r.base32nopad = d(M(5), h("ABCDEFGHIJKLMNOPQRSTUVWXYZ234567"), p("")),
        r.base32hex = d(M(5), h("0123456789ABCDEFGHIJKLMNOPQRSTUV"), g(5), p("")),
        r.base32hexnopad = d(M(5), h("0123456789ABCDEFGHIJKLMNOPQRSTUV"), p("")),
        r.base32crockford = d(M(5), h("0123456789ABCDEFGHJKMNPQRSTVWXYZ"), p(""), m((e => e.toUpperCase().replace(/O/g, "0").replace(/[IL]/g, "1"))));
        ...
        } : d(M(6), h("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"), g(6), p("")),
        r.base64nopad = d(M(6), h("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"), p("")),
        r.base64url = I ? {
            encode: e => (s(e),
            e.toBase64({
                alphabet: "base64url"
        ...
        } : d(M(6), h("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_"), g(6), p("")),
        r.base64urlnopad = d(M(6), h("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_"), p(""));
        const A = e => d(_(58), h(e), p(""));
        ...
        const R = d(h("qpzry9x8gf2tvdw0s3jn54khce6mua7l"), p(""))
        ...
        r.hex = x ? k : d(M(4), h("0123456789abcdef"), p(""), m((e => {
 ...
 */
    ...
    126: [function(e, t, r) {
        (function(r, n) {
            (function() {
                ...
                ;
                var f, d, h, p = e("./internal/streams/buffer_list"), g = e("./internal/streams/destroy"), m = e("./internal/streams/state").getHighWaterMark, y = e("../errors").codes, w = y.ERR_INVALID_ARG_TYPE, b = y.ERR_STREAM_PUSH_AFTER_EOF, v = y.ERR_METHOD_NOT_IMPLEMENTED, E = y.ERR_STREAM_UNSHIFT_AFTER_END_EVENT;
                e("inherits")(j, o);
                ...
                j.prototype.pipe = function(e, t) {
                    ...
                    function d(t) {
                        ...
                        var r = e.write(t);
                        u("dest.write", r),
                        !1 === r && ((1 === s.pipesCount && s.pipes === e || s.pipesCount > 1 && -1 !== B(s.pipes, e)) && !f && (u("false write response, pause", s.awaitDrain),
                        s.awaitDrain++),
                        n.pause())
                    }
                    function h(t) {
                    ...
                    if (e._writev && r && r.next) {
                        ...
                        for (; r; ) {
                            var u = r.chunk
                              , l = r.encoding
                              , f = r.callback;
                            if (I(e, t, !1, t.objectMode ? 1 : u.length, u, l, f),
                            r = r.next,
    ...
    140: [function(e, t, r) {
        ...
        e.trim().replace(l[t.includePrerelease ? f.GTE0PRE : f.GTE0], ""))
          , N = e => (t, r, n, s, i, o, a, c, u, l, f, d) => `${r = E(n) ? "" : E(s) ? `>=${n}.0.0${e ? "-0" : ""}` : E(i) ? `>=${n}.${s}.0${e ? "-0" : ""}` : o ? `>=${r}` : `>=${r}${e ? "-0" : ""}`} ${c = E(u) ? "" : E(l) ? `<${+u + 1}.0.0-0` : E(f) ? `<${u}.${+l + 1}.0-0` : d ? `<=${u}.${l}.${f}-${d}` : e ? `<${u}.${l}.${+f + 1}-0` : `<=${c}`}`.trim()
          , O = (e, t, r) => {
            for (let r = 0; r < e.length; r++)
                if (!e[r].test(t))
                    return !1;
