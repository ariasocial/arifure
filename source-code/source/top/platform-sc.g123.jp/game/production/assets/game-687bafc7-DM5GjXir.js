import {g as $r} from "./game-d8b296a6-D6-XlEtG.js";
function Br(Fe, N) {
...
function Ur() {
    ...
    function(Fe) {
        (function(N, be) {
        ...
        )(typeof window < "u" ? window : zr, function(N, be) {
            var B = []
              , xe = Object.getPrototypeOf
              , V = B.slice
              , _t = B.flat ? function(e) {
            ...
            function je(e) {
                return e == null ? e + "" : typeof e == "object" || typeof e == "function" ? tt[Ft.call(e)] || "object" : typeof e
            }
            var Bt = "3.7.1"
              , Pn = /HTML$/i
              , i = function(e, t) {
            ...
            i.extend({
                ...
                isPlainObject: function(e) {
                    var t, n;
                    return !e || Ft.call(e) !== "[object Object]" ? !1 : (t = xe(e),
                    t ? (n = We.call(t, "constructor") && t.constructor,
                    typeof n == "function" && Wt.call(n) === On) : !0)
                },
                ...
                makeArray: function(e, t) {
                    var n = t || [];
                    return e != null && (ht(Object(e)) ? i.merge(n, typeof e == "string" ? [e] : e) : et.call(n, e)),
                    n
                },
            ...
            typeof Symbol == "function" && (i.fn[Symbol.iterator] = B[Symbol.iterator]),
            ...
            var pe = k
              , gt = et;
            (function() {
                var e, t, n, r, o, u = gt, a, c, f, d, y, b = i.expando, h = 0, x = 0, D = ft(), R = ft(), O = ft(), X = ft(), U = function(s, l) {
                    return s === l && (o = !0),
                    0
                }, ae = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", se = "(?:\\\\[\\da-fA-F]{1,6}" + F + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", M = "\\[" + F + "*(" + se + ")(?:" + F + "*([*^$|!~]?=)" + F + `*(?:'((?:\\\\.|[^\\\\'])*)'|"((?:\\\\.|[^\\\\"])*)"|(` + se + "))|)" + F + "*\\]", Ae = ":(" + se + `)(?:\\((('((?:\\\\.|[^\\\\'])*)'|"((?:\\\\.|[^\\\\"])*)")|((?:\\\\.|[^\\\\()[\\]]|` + M + ")*)|.*)\\)|)", I = new RegExp(F + "+","g"), z = new RegExp("^" + F + "*," + F + "*"), Je = new RegExp("^" + F + "*([>+~]|" + F + ")" + F + "*"), Lt = new RegExp(F + "|>"), fe = new RegExp(Ae), Ke = new RegExp("^" + se + "$"), ce = {
                    ID: new RegExp("^#(" + se + ")"),
                    CLASS: new RegExp("^\\.(" + se + ")"),
                    TAG: new RegExp("^(" + se + "|[*])"),
                    ATTR: new RegExp("^" + M),
                ...
                }, me = /^(?:input|select|textarea|button)$/i, Te = /^h\d$/i, te = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, Ot = /[+~]/, ye = new RegExp("\\\\[\\da-fA-F]{1,6}" + F + "?|\\\\([^\\r\\n\\f])","g"), ve = function(s, l) {
                ...
                try {
                    u.apply(B = V.call(pe.childNodes), pe.childNodes),
                ...
                function _(s, l, p, g) {
                    ...
                    f)) {
                        ...
                        if (!X[s + " "] && (!d || !d.test(s))) {
                            if (A = s,
                            j = l,
                            P === 1 && (Lt.test(s) || Je.test(s))) {
                                for (j = Ot.test(s) && Ht(l.parentNode) || l,
                                (j != l || !q.scope) && ((w = l.getAttribute("id")) ? w = i.escapeSelector(w) : l.setAttribute("id", w = b)),
                                H = Ze(s),
                                m = H.length; m--; )
                            ...
                            try {
                                return u.apply(p, j.querySelectorAll(A)),
                                p
                            } catch {
                                X(s, !0)
                            } finally {
                ...
                function Nn(s) {
                    return function(l) {
                        return "form"in l ? l.parentNode && l.disabled === !1 ? "label"in l ? "label"in l.parentNode ? l.parentNode.disabled === s : l.disabled === s : l.isDisabled === s || l.isDisabled !== !s && Mr(l) === s : l.disabled === s : "label"in l ? l.disabled === s : !1
                    }
                }
                function De(s) {
                ...
                function Ce(s) {
                    ...
                    c.msMatchesSelector && pe != a && (l = a.defaultView) && l.top !== l && l.addEventListener("unload", Pr),
                    q.getById = Ie(function(g) {
                ...
                _.contains = function(s, l) {
                    return (s.ownerDocument || s) != a && Ce(s),
                    i.contains(s, l)
                }
                ,
                _.attr = function(s, l) {
                    ...
                    var p = t.attrHandle[l.toLowerCase()]
                      , g = p && We.call(t.attrHandle, l.toLowerCase()) ? p(s, l, !f) : void 0;
                ...
                t = i.expr = {
                    ...
                    preFilter: {
                        ...
                        PSEUDO: function(s) {
                            var l, p = !s[6] && s[2];
                            return ce.CHILD.test(s[0]) ? null : (s[3] ? s[2] = s[4] || s[5] || "" : p && fe.test(p) && (l = Ze(p, !0)) && (l = p.indexOf(")", p.length - l) - p.length) && (s[0] = s[0].slice(0, l),
                            s[2] = p.slice(0, l)),
                            s.slice(0, 3))
                        }
                    },
                        ...
                        CHILD: function(s, l, p, g, v) {
                            ...
                            : function(C, H, A) {
                                ...
                                if (ne) {
                                    ...
                                    if (Z = [T ? ne.firstChild : ne.lastChild],
                                    T && _e) {
                                        for (P = ne[b] || (ne[b] = {}),
                                        j = P[s] || [],
                                        W = j[0] === h && j[1],
                                        Q = W && j[2],
                                        E = W && ne.childNodes[W]; E = ++W && E && E[G] || (Q = W = 0) || Z.pop(); )
                                            if (E.nodeType === 1 && ++Q && E === C) {
                                                P[s] = [h, W, Q];
                                                break
                                            }
                                    } else if (_e && (P = C[b] || (C[b] = {}),
                                    j = P[s] || [],
                                    W = j[0] === h && j[1],
                                    Q = W),
                                    Q === !1)
                                        for (; (E = ++W && E && E[G] || (Q = W = 0) || Z.pop()) && !((w ? $(E, le) : E.nodeType === 1) && ++Q && (_e && (P = E[b] || (E[b] = {}),
                                        P[s] = [h, Q]),
                                        E === C)); )
                                            ;
                                    return Q -= v,
                    ...
                    pseudos: {
                        ...
                        lang: ie(function(s) {
                            return Ke.test(s || "") || _.error("unsupported lang: " + s),
                ...
                for (e in {
                    ...
                    t.pseudos[e] = _r(e);
                function jn() {}
                jn.prototype = t.filters = t.pseudos,
                t.setFilters = new jn;
                function Ze(s, l) {
                    ...
                    w = [],
                    C = t.preFilter; T; ) {
                        (!p || (g = z.exec(T))) && (g && (T = T.slice(g[0].length) || T),
                        w.push(v = [])),
                        p = !1,
                        (g = Je.exec(T)) && (p = g.shift(),
                        v.push({
                            value: p,
                            type: g[0].replace($e, " ")
                        }),
                ...
                function Mt(s, l, p, g, v, m) {
                    return g && !g[b] && (g = Mt(g)),
                    v && !v[b] && (v = Mt(v, m)),
                    ie(function(T, w, C, H) {
                        var A, j, P, E, W = [], Z = [], G = w.length, ne = T || Fr(l || "*", C.nodeType ? [C] : C, []), le = s && (T || !l) ? dt(ne, W, s, C, H) : ne;
                        if (p ? (E = v || (T ? s : G || g) ? [] : w,
                        p(le, E, C, H)) : E = le,
                        g)
                            for (A = dt(E, Z),
                        ...
                        if (T) {
                            ...
                            E = dt(E === w ? E.splice(G, E.length) : E),
                        ...
                        if (p = t.relative[s[w].type])
                            ...
                            p[b]) {
                                for (g = ++w; g < v && !t.relative[s[g].type]; g++)
                                    ;
                                return Mt(w > 1 && Pt(A), w > 1 && ct(s.slice(0, w - 1).concat({
                                    value: s[w - 2].type === " " ? "*" : ""
                                })).replace($e, "$1"), p, w < g && Rt(s.slice(w, g)), g < v && Rt(s = s.slice(g)), g < v && ct(s))
                            }
                            A.push(p)
                        }
                    return Pt(A)
                ...
                function Wr(s, l) {
                    var p = l.length > 0
                      , g = s.length > 0
                      , v = function(m, T, w, C, H) {
                        var A, j, P, E = 0, W = "0", Z = m && [], G = [], ne = n, le = m || g && t.find.TAG("*", H), _e = h += ne == null ? 1 : Math.random() || .1, Q = le.length;
                        for (H && (n = T == a || T || H); W !== Q && (A = le[W]) != null; W++) {
                            if (g && A) {
                                for (j = 0,
                                !T && A.ownerDocument != a && (Ce(A),
                                w = !f); P = s[j++]; )
                                    if (P(A, T || a, w)) {
                                        u.call(C, A);
                                        break
                        ...
                        p && W !== E) {
                            ...
                            if (m) {
                                if (E > 0)
                                    for (; W--; )
                                        Z[W] || G[W] || (G[W] = Mn.call(C));
                                G = dt(G)
                            }
                            u.apply(C, G),
                            H && !m && G.length > 0 && E + l.length > 1 && i.uniqueSort(C)
                        }
                        return H && (h = _e,
                        n = ne),
                        Z
                ...
                function kn(s, l, p, g) {
                    ...
                    A.length === 1) {
                        ...
                        !t.relative[w = T.type]); )
                            if ((C = t.find[w]) && (g = C(T.matches[0].replace(ye, ve), Ot.test(m[0].type) && Ht(l.parentNode) || l))) {
                                if (m.splice(v, 1),
                                s = g.length && ct(m),
                                !s)
                                    return u.apply(p, g),
                    ...
                    return (H || It(s, A))(g, l, !f, p, !l || Ot.test(s) && Ht(l.parentNode) || l),
                    p
                }
                q.sortStable = b.split("").sort(U).join("") === b,
                Ce(),
                q.sortDetached = Ie(function(s) {
            ...
            i.fn.extend({
                ...
                is: function(e) {
                    return !!yt(this, typeof e == "string" && Ut.test(e) ? i(e) : e || [], !1).length
                }
            });
            ...
            i.each({
                ...
                contents: function(e) {
                    return e.contentDocument != null && xe(e.contentDocument) ? e.contentDocument : ($(e, "template") && (e = e.content || e),
                ...
                i.fn[e] = function(n, r) {
                    ...
                    this.length > 1 && (zn[e] || i.uniqueSort(o),
                    Bn.test(e) && o.reverse()),
                    this.pushStack(o)
                }
            });
                        ...
                        then: function(u, a, c) {
                            ...
                            function d(y, b, h, x) {
                                return function() {
                                    var D = this
                                      ...
                                      , O = function() {
                                        ...
                                        if (!(y < f)) {
                                            ...
                                            L(ae) ? x ? ae.call(U, d(f, b, qe, x), d(f, b, nt, x)) : (f++,
                                            ae.call(U, d(f, b, qe, x), d(f, b, nt, x), d(f, b, qe, b.notifyWith))) : (h !== qe && (D = void 0,
                                            R = [U]),
                                            (x || b.resolveWith)(D, R))
                                        }
                                    }
                                      , X = x ? O : function() {
                                        try {
                                            ...
                                            i.Deferred.exceptionHook && i.Deferred.exceptionHook(U, X.error),
                                            y + 1 >= f && (h !== nt && (D = void 0,
                                            R = [U]),
                                            b.rejectWith(D, R))
                                        }
                                    ...
                                    ;
                                    y ? X() : (i.Deferred.getErrorHook ? X.error = i.Deferred.getErrorHook() : i.Deferred.getStackHook && (X.error = i.Deferred.getStackHook()),
                                    N.setTimeout(X))
                                }
                            }
                            return i.Deferred(function(y) {
                                t[0][3].add(d(0, y, L(c) ? c : qe, y.notifyWith)),
                                t[1][3].add(d(0, y, L(u) ? u : qe)),
                                t[2][3].add(d(0, y, L(a) ? a : nt))
                            }).promise()
                        },
                        promise: function(u) {
                ...
                when: function(e) {
                    var t = arguments.length
                      ...
                      , a = function(c) {
                        return function(f) {
                            r[c] = this,
                            o[c] = arguments.length > 1 ? V.call(arguments) : f,
                            --t || u.resolveWith(r, o)
                        }
                    };
                    if (t <= 1 && (Qt(e, u.done(a(n)).resolve, u.reject, !t),
            ...
            i.Deferred.exceptionHook = function(e, t) {
                N.console && N.console.warn && e && Vn.test(e.name) && N.console.warn("jQuery.Deferred exception: " + e.message, e.stack, t)
            }
            ,
            ...
            i.fn.ready = function(e) {
                return vt.then(e).catch(function(t) {
                    i.readyException(t)
                }),
                this
            }
            ...
            i.extend({
                ...
                ready: function(e) {
                    ...
                    !(e !== !0 && --i.readyWait > 0) && vt.resolveWith(k, [i]))
                }
            }),
            i.ready.then = vt.then;
            function rt() {
                k.removeEventListener("DOMContentLoaded", rt),
                N.removeEventListener("load", rt),
                i.ready()
            }
            k.readyState === "complete" || k.readyState !== "loading" && !k.documentElement.doScroll ? N.setTimeout(i.ready) : (k.addEventListener("DOMContentLoaded", rt),
            N.addEventListener("load", rt));
            ...
            function Yt(e, t, n) {
                ...
                if (n === void 0 && e.nodeType === 1)
                    if (r = "data-" + t.replace(Jn, "-$&").toLowerCase(),
                    n = e.getAttribute(r),
                    typeof n == "string") {
                        try {
                            n = Kn(n)
            ...
            var it = function(e, t) {
                return e = t || e,
                e.style.display === "none" || e.style.display === "" && Le(e) && i.css(e, "display") === "none"
            };
            function Kt(e, t, n, r) {
            ...
            function Oe(e, t) {
                for (var n, r, o = [], u = 0, a = e.length; u < a; u++)
                    ...
                    o[u] || (r.style.display = "")),
                    r.style.display === "" && it(r) && (o[u] = er(r))) : n !== "none" && (o[u] = "none",
                    S.set(r, "display", n)));
                for (u = 0; u < a; u++)
            ...
            i.event = {
                ...
                add: function(e, t, n, r, o) {
                    ...
                    if (Be(e))
                        ...
                        (a = O.handle) || (a = O.handle = function(X) {
                ...
                remove: function(e, t, n, r, o) {
                    ...
                    if (!(!O || !(f = O.events))) {
                        ...
                        d = t.length; d--; ) {
                            ...
                            a && !h.length && ((!b.teardown || b.teardown.call(e, D, O.handle) === !1) && i.removeEvent(e, x, O.handle),
                            delete f[x])
                        }
                ...
                special: {
                    ...
                    click: {
                        ...
                        trigger: function(e) {
                            var t = this || e;
                            return Ve.test(t.type) && t.click && $(t, "input") && ot(t, "click"),
                            !0
                        },
                        _default: function(e) {
                            var t = e.target;
            ...
            i.Event = function(e, t) {
                ...
                this.type = e.type,
                this.isDefaultPrevented = e.defaultPrevented || e.defaultPrevented === void 0 && e.returnValue === !1 ? He : Pe,
            ...
            function Me(e, t, n, r) {
                ...
                if (D || b > 1 && typeof x == "string" && !q.checkClone && rr.test(x))
                    return e.each(function(R) {
                        var O = e.eq(R);
                        D && (t[0] = x.call(this, R, O.html())),
                        Me(O, t, n, r)
                    });
                if (b && (o = nn(t, e[0].ownerDocument, !1, e, r),
                u = o.firstChild,
                o.childNodes.length === 1 && (o = u),
                u || r)) {
                    for (a = i.map(J(o, "script"), or),
                    c = a.length; y < b; y++)
                        f = o,
                        y !== h && (f = i.clone(f, !0, !0),
                        c && i.merge(a, J(f, "script"))),
                        n.call(e[y], f, y);
                    if (c)
                        ...
                        y = 0; y < c; y++)
                            f = a[y],
                            tn.test(f.type || "") && !S.access(f, "globalEval") && i.contains(d, f) && (f.src && (f.type || "").toLowerCase() !== "module" ? i._evalUrl && !f.noModule && i._evalUrl(f.src, {
            ...
            function an(e, t, n) {
                for (var r, o = t ? i.filter(t, e) : e, u = 0; (r = o[u]) != null; u++)
                    ...
                    r.parentNode && (n && Le(r) && bt(J(r, "script")),
            ...
            i.fn.extend({
                ...
                empty: function() {
                    for (var e, t = 0; (e = this[t]) != null; t++)
                        e.nodeType === 1 && (i.cleanData(J(e, !1)),
                        e.textContent = "");
                    return this
                },
                clone: function(e, t) {
                    ...
                    return he(this, function(t) {
                        ...
                        if (typeof t == "string" && !nr.test(t) && !ee[(en.exec(t) || ["", ""])[1].toLowerCase()]) {
                            ...
                            try {
                                for (; r < o; r++)
                                    n = this[r] || {},
                                    n.nodeType === 1 && (i.cleanData(J(n, !1)),
                                    n.innerHTML = t);
                                n = 0
                            } catch {}
                        }
                ...
                replaceWith: function() {
                    ...
                    return Me(this, arguments, function(t) {
                        ...
                        i.inArray(this, e) < 0 && (i.cleanData(J(this)),
            ...
            function Xe(e, t, n) {
                var r, o, u, a, c = Tt.test(t), f = e.style;
                return n = n || ut(e),
                n && (a = n.getPropertyValue(t) || n[t],
                c && a && (a = a.replace($e, "$1") || void 0),
                a === "" && !Le(e) && (a = i.style(e, t)),
                !q.pixelBoxStyles() && mt.test(a) && sr.test(t) && (r = f.width,
                o = f.minWidth,
                u = f.maxWidth,
            ...
            function gn(e, t, n) {
                ...
                a && (c = e[f])),
                c = parseFloat(c) || 0,
                c + wt(e, t, n || (u ? "border" : "content"), a, r, c) + "px"
            }
            i.extend({
                cssHooks: {
                    opacity: {
                ...
                style: function(e, t, n, r) {
                    if (!(!e || e.nodeType === 3 || e.nodeType === 8 || !e.style)) {
                        var o, u, a, c = ue(t), f = Tt.test(t), d = e.style;
                        if (f || (t = Ct(c)),
                        a = i.cssHooks[t] || i.cssHooks[c],
                        n !== void 0) {
                            if (u = typeof n,
                            u === "string" && (o = Ue.exec(n)) && o[1] && (n = Kt(e, t, o),
                            u = "number"),
                            n == null || n !== n)
                                return;
            ...
            i.each(["height", "width"], function(e, t) {
                i.cssHooks[t] = {
                    get: function(n, r, o) {
                        if (r)
                            return cr.test(i.css(n, "display")) && (!n.getClientRects().length || !n.getBoundingClientRect().width) ? sn(n, lr, function() {
                                return gn(n, t, o)
                            }) : gn(n, t, o)
                    },
                    set: function(n, r, o) {
                        var u, a = ut(n), c = !q.scrollboxSize() && a.position === "absolute", f = c || o, d = f && i.css(n, "boxSizing", !1, a) === "border-box", y = o ? wt(n, t, o, d, a) : 0;
                        return d && c && (y -= Math.ceil(n["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(a[t]) - wt(n, t, "border", !1, a) - .5)),
                        y && (u = Ue.exec(r)) && (u[3] || "px") !== "px" && (n.style[t] = r,
                        r = i.css(n, t)),
                        hn(n, r, y)
                    }
                }
            }),
            i.cssHooks.marginLeft = fn(q.reliableMarginLeft, function(e, t) {
                if (t)
                    return (parseFloat(Xe(e, "marginLeft")) || e.getBoundingClientRect().left - sn(e, {
                        marginLeft: 0
                    }, function() {
            ...
            K.propHooks = {
                _default: {
                    ...
                    set: function(e) {
                        i.fx.step[e.prop] ? i.fx.step[e.prop](e) : e.elem.nodeType === 1 && (i.cssHooks[e.prop] || e.elem.style[Ct(e.prop)] != null) ? i.style(e.elem, e.prop, e.now + e.unit) : e.elem[e.prop] = e.now
                    }
                }
            },
            ...
            i.fx.step = {};
            var Re, at, dr = /^(?:toggle|show|hide)$/, pr = /queueHooks$/;
            function St() {
                at && (k.hidden === !1 && N.requestAnimationFrame ? N.requestAnimationFrame(St) : N.setTimeout(St, i.fx.interval),
                i.fx.tick())
            }
            function yn() {
            ...
            function hr(e, t, n) {
                ...
                !(!f && i.isEmptyObject(x))) {
                    ...
                    f = !1;
                    for (r in x)
                        f || (O ? "hidden"in O && (R = O.hidden) : O = S.access(e, "fxshow", {
                            display: d
                        }),
                        u && (O.hidden = !R),
                        R && Oe([e], !0),
            ...
            function re(e, t, n) {
                var r, o, u = 0, a = re.prefilters.length, c = i.Deferred().always(function() {
                    ...
                    if (o)
                        return !1;
                    for (var b = Re || yn(), h = Math.max(0, d.startTime + d.duration - b), x = h / d.duration || 0, D = 1 - x, R = 0, O = d.tweens.length; R < O; R++)
                        d.tweens[R].run(D);
                    return c.notifyWith(e, [d, D, h]),
                    D < 1 && O ? h : (O || c.notifyWith(e, [d, 1, 0]),
                    c.resolveWith(e, [d]),
                    !1)
                }, d = c.promise({
                    elem: e,
            ...
            i.Animation = i.extend(re, {
                tweeners: {
                    "*": [function(e, t) {
                        ...
                        return Kt(n.elem, e, Ue.exec(t), n),
                        n
                    }
                    ]
                },
                ...
                attr: function(e, t, n) {
                    ...
                    if (!(u === 3 || u === 8 || u === 2)) {
                        if (typeof e.getAttribute > "u")
                            return i.prop(e, t, n);
                        if ((u !== 1 || !i.isXMLDoc(e)) && (o = i.attrHooks[t.toLowerCase()] || (i.expr.match.bool.test(t) ? bn : void 0)),
                        n !== void 0) {
                            if (n === null) {
                                i.removeAttr(e, t);
                                return
            ...
            i.fn.extend({
                ...
                toggleClass: function(e, t) {
                    ...
                    }) : typeof t == "boolean" && c ? t ? this.addClass(e) : this.removeClass(e) : (n = Et(e),
                    this.each(function() {
                        if (c)
                            for (u = i(this),
                            o = 0; o < n.length; o++)
            ...
            i.fn.extend({
                val: function(e) {
                    ...
                    typeof n == "string" ? n.replace(br, "") : n ?? "")) : void 0
                }
            }),
            i.extend({
                valHooks: {
...
`) : e)),
            ...
            i.extend(i.event, {
                trigger: function(e, t, n, r) {
                    ...
                    if (u = b = a = n = n || k,
                    !(n.nodeType === 3 || n.nodeType === 8) && !mn.test(x + i.event.triggered) && (x.indexOf(".") > -1 && (D = x.split("."),
                    x = D.shift(),
                    D.sort()),
                    f = x.indexOf(":") < 0 && "on" + x,
                    ...
                    !(!r && y.trigger && y.trigger.apply(n, t) === !1))) {
                        if (!r && !y.noBubble && !Ne(n)) {
                            ...
                            mn.test(c + x) || (u = u.parentNode); u; u = u.parentNode)
                                h.push(u),
                                a = u;
                        ...
                        for (o = 0; (u = h[o++]) && !e.isPropagationStopped(); )
                            ...
                            d && d.apply(u, t),
                            d = f && u[f],
                            d && d.apply && Be(u) && (e.result = d.apply(u, t),
                            e.result === !1 && e.preventDefault());
                        return e.type = x,
                        !r && !e.isDefaultPrevented() && (!y._default || y._default.apply(h.pop(), t) === !1) && Be(n) && f && L(n[x]) && !Ne(n) && (a = n[f],
                        a && (n[f] = null),
                        i.event.triggered = x,
                        e.isPropagationStopped() && b.addEventListener(x, Tn),
                        n[x](),
                        e.isPropagationStopped() && b.removeEventListener(x, Tn),
            ...
            function Dt(e, t, n, r) {
                ...
                if (Array.isArray(t))
                    i.each(t, function(u, a) {
                        n || xr.test(e) ? r(e, a) : Dt(e + "[" + (typeof a == "object" && a != null ? u : "") + "]", a, n, r)
                    });
            ...
            i.fn.extend({
                ...
                serializeArray: function() {
                    return this.map(function() {
                        ...
                        var e = this.type;
                        return this.name && !i(this).is(":disabled") && Tr.test(this.nodeName) && !mr.test(e) && (this.checked || !Ve.test(e))
                    }).map(function(e, t) {
                        var n = i(this).val();
                        return n == null ? null : Array.isArray(n) ? i.map(n, function(r) {
                            return {
                                name: t.name,
                                value: r.replace(Cn, `\r
`)
                            }
                        }) : {
                            name: t.name,
...
`)
            ...
            i.extend({
                ...
                ajax: function(e, t) {
                    ...
                    if (R.promise(M),
                    h.url = ((e || h.url || Qe.href) + "").replace(Nr, Qe.protocol + "//"),
                    ...
                    h.crossDomain == null) {
                        ...
                        try {
                            c.href = h.url,
                            c.href = c.href,
                            h.crossDomain = jt.protocol + "//" + jt.host != c.protocol + "//" + c.host
                        } catch {
                            h.crossDomain = !0
                        }
                    }
                    ...
                    r = h.url.replace(wr, ""),
                    h.hasContent ? h.data && h.processData && (h.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && (h.data = h.data.replace(Cr, "+")) : (b = h.url.slice(r.length),
                    h.data && (h.processData || typeof h.data == "string") && (r += (At.test(r) ? "&" : "?") + h.data,
                    delete h.data),
                    h.cache === !1 && (r = r.replace(Sr, "$1"),
                    b = (At.test(r) ? "&" : "?") + "_=" + xn.guid++ + b),
                    h.url = r + b),
                    ...
                    M.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + (h.dataTypes[0] !== "*" ? ", " + Sn + "; q=0.01" : "") : h.accepts["*"]);
                    for (y in h.headers)
                    ...
                    function Ae(I, z, Je, Lt) {
                        ...
                        me = kr(h, me, M, fe),
                        fe ? (h.ifModified && (Te = M.getResponseHeader("Last-Modified"),
                        Te && (i.lastModified[r] = Te),
                        Te = M.getResponseHeader("etag"),
                        Te && (i.etag[r] = Te)),
                        I === 204 || h.type === "HEAD" ? te = "nocontent" : I === 304 ? te = "notmodified" : (te = me.state,
                        Ke = me.data,
                        ce = me.error,
                        fe = !ce)) : (ce = te,
                        (I || !te) && (te = "error",
                        ...
                        M.status = I,
                        M.statusText = (z || te) + "",
                        fe ? R.resolveWith(x, [Ke, te, M]) : R.rejectWith(x, [M, te, ce]),
                        M.statusCode(X),
                        X = void 0,
                        d && D.trigger(fe ? "ajaxSuccess" : "ajaxError", [M, h, fe ? Ke : ce]),
                        O.fireWith(x, [M, te]),
            ...
            q.cors = !!Ye && "withCredentials"in Ye,
            q.ajax = Ye = !!Ye,
                        ...
                        send: function(r, o) {
                            ...
                            t = function(c) {
                                return function() {
                                    ...
                                    c === "abort" ? a.abort() : c === "error" ? typeof a.status != "number" ? o(0, "error") : o(a.status, a.statusText) : o(qr[a.status] || a.status, a.statusText, (a.responseType || "text") !== "text" || typeof a.responseText != "string" ? {
                                        binary: a.response
                                    } : {
                                        text: a.responseText
            ...
            i.ajaxPrefilter("json jsonp", function(e, t, n) {
                var r, o, u, a = e.jsonp !== !1 && (qt.test(e.url) ? "url" : typeof e.data == "string" && (e.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && qt.test(e.data) && "data");
                if (a || e.dataTypes[0] === "jsonp")
                    return r = e.jsonpCallback = L(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
                    a ? e[a] = e[a].replace(qt, "$1" + r) : e.jsonp !== !1 && (e.url += (At.test(e.url) ? "&" : "?") + e.jsonp + "=" + r),
                    ...
                    ,
                    n.always(function() {
                        o === void 0 ? i(N).removeProp(r) : N[r] = o,
            ...
            i.parseHTML = function(e, t, n) {
                ...
                o = Vt.exec(e),
                u = !n && [],
                o ? [t.createElement(o[1])] : (o = nn([e], t, u),
            ...
            i.each({
                ...
                i.fn[e] = function(r) {
                    return he(this, function(o, u, a) {
                        var c;
                        if (Ne(o) ? c = o : o.nodeType === 9 && (c = o.defaultView),
                        a === void 0)
                            return c ? c[t] : o[u];
            ...
            i.each(["top", "left"], function(e, t) {
                i.cssHooks[t] = fn(q.pixelPosition, function(n, r) {
                    if (r)
                        return r = Xe(n, t),
                ...
                i.each({
                    ...
                    i.fn[r] = function(o, u) {
                        ...
                        return he(this, function(f, d, y) {
                            var b;
                            return Ne(f) ? r.indexOf("outer") === 0 ? f["inner" + e] : f.document.documentElement["client" + e] : f.nodeType === 9 ? (b = f.documentElement,
            ...
            return i.noConflict = function(e) {
                return N.$ === i && (N.$ = Hr),
                e && N.jQuery === i && (N.jQuery = Or),
                i
            }
            ,
            typeof be > "u" && (N.jQuery = N.$ = i),
            i
        })
    }(pt)),
    pt.exports
